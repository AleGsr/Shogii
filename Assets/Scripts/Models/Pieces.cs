...
public abstract class UpgradePiece : SingleMovePiece
{

    public UpgradePiece(int2 coor, PieceType type, Team team, Piece normalSide) : base(coor, type, team) 
    {
...
public abstract class ComplexUpgradedPiece : UpgradePiece
{
    protected List<int2> directions = new List<int2>();
...
public class UpGold : UpgradePiece
{
